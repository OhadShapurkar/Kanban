...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        public GradingService()
        {
            ...
            userService = serviceFactory._us;
            boardService = serviceFactory._bs;
            taskService = serviceFactory._ts;
        }
        ...
        {
           return boardService.ChangeLimit(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return taskService.CreateTask(email, boardName, title, description, dueDate);
        }
        ...
        {
            return taskService.EditTaskDueDate(email, boardName, taskId,columnOrdinal, dueDate);
        }
        ...
        {
            return taskService.EditTaskTitle(email,boardName,taskId,columnOrdinal,title);
        }
        ...
        {
            return taskService.EditTaskDescription(email, boardName, taskId,columnOrdinal, description);
        }
        ...
        {
           return boardService.InProgressList(email);
        }
